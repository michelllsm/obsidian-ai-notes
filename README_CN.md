...
**Obsidian AI Notes** 是一个 AI Skill，让你通过简单指令（如 `day`、`note`、`exp`）自动创建、归类和管理结构化的 Obsidian 笔记。
...
> **为什么推荐列表很短？** YouTube、B站、公众号、X 等平台的信息采集通过内置工具已能获得足够质量的结果，无需额外安装 Skill。仅小红书等需要搜索/互动数据的平台才需要专属 Skill。详见 `references/Extended Toolkit拓展工具包.md`。
...
> **说明：** 本 Skill 设计为通用规则，可自由修改以适应你的工作流。详见 [SKILL.md](obsidian-ai-notes%20skill配置/SKILL.md) 和 [references/command-reference.md](references/command-reference.md)。

**English version:** [README.md](obsidian-ai-notes%20skill配置/README.md)
