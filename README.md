...
**Obsidian AI Notes** is an AI Skill that lets you create, organize, and manage structured Obsidian notes through simple commands like `day`, `note`, `idea`.
...
- **Smart Archiving:** No matching category? AI creates a new one
...
| Skill | What it does | Level | Setup |
|-------|-------------|-------|-------|
